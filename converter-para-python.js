...
const pythonProjectPath = './freecodecamp-backend-python';

// Estrutura dos arquivos com conteúdo básico
const filesContent = {
    'main.py': `
...
`,
    ...
    'controllers/date_controller.py': `
...
`,
    ...
    'controllers/exercise_tracker_controller.py': `
...
`,
    ...
    'controllers/file_metadata_controller.py': `
...
`,
    ...
    'controllers/url_shortener_controller.py': `
import dns.resolver
from fastapi import HTTPException
...
`,
    ...
    'controllers/whoami_controller.py': `
...
`,
    ...
    'models/exercise_tracker_model.py': `
users = []
exercises = []
`,

    'routes/date_routes.py': `
...
`,
    ...
    'routes/exercise_tracker_routes.py': `
...
`,
    ...
    'routes/file_metadata_routes.py': `
...
`,
    ...
    'routes/url_shortener_routes.py': `
...
function createFileStructure() {
    for (const [file, content] of Object.entries(filesContent)) {
        const filePath = path.join(pythonProjectPath, file);
        ensureDirectoryExistence(filePath);

        fs.writeFileSync(filePath, content.trim());
    }

    console.log('Python project structure created with basic content.');
}
